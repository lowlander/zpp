...
public:
  ...
  ///
  /// @brief Get the minium coop numeric value
  ///
  /// The minium coop numric value is the highest
  /// thread priority
  ///
  ...
  /// @brief Get the minium coop numeric value
  ///
  /// The maxium coop numric value is the lowest
  /// coop thread priority
  ///
  /// @return The smallest numeric value
  ///
  ...
  ///
  /// @brief Get the minium preempt numeric value
  ///
  /// The minium preempt numric value is the highest
  /// preempt thread priority
  ///
  /// @return The smallest numeric value
  ///
  static constexpr thread_prio min_preempt_numeric() noexcept
  {
    return highest_preempt();
  }
